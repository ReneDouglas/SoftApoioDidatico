...
class TDataGridColumn
{
     ...
     * mйtodo setAction()
     * define uma aзгo a ser executada quando o usuбrio
     * clicar sobre o dado da coluna
     * @param $action = objeto TDataGridAction contendo a aзгo
     */
	public function addDataAction(TDataGridAction $action)
    {
        $this->dataAction = $action;
    }
	/**
     * mйtodo getDataAcrion()
     * retorna a aзгo vinculada ao dado da coluna
     */
    public function getDataAcrion()
    {
