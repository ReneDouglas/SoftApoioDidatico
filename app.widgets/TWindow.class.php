...
class TWindow
{
    ...
    public function show()
    {
		...
		$typeX= is_numeric($this->x)? "px" : "";
		$typeY= is_numeric($this->y)? "px" : "";
        ...
        $style->left           = $this->x.$typeX;
        $style->top            = $this->y.$typeY;
        ...
        $link = new TElement('a');
        $link->add("<font face='Arial' size='2' color='white'><b>X</b></font>");
